...
(function() {
	...
	ORBEON.xforms.control.CalendarResources = {
		"cn" : {
			properties : {
				"MONTHS_LONG" : [ "一月", "二月", "三月", "四月", "五月", "六月", "七月",
						"八月", "九月", "十月", "十一月", "十二月" ],
				"WEEKDAYS_SHORT" : [ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri",
						"Sat" ],
				"START_WEEKDAY" : 0
			},
			navigator : {
		...
		"fi" : {
			properties : {
				"MONTHS_LONG" : [ "Tammikuu", "Helmikuu", "Maaliskuu",
						"Huhtikuu", "Toukokuu", "Kes\u00e4kuu",
						"Hein\u00e4kuu", "Elokuu", "Syyskuu", "Lokakuu",
						"Marraskuu", "Joulukuu" ],
				"MONTHS_SHORT" : [ "Tammi", "Helmi", "Maalis", "Huhti",
		...
		"fr" : {
			properties : {
				"MONTHS_LONG" : [ "Janvier", "F\xe9vrier", "Mars", "Avril",
		...
		"es" : {
			properties : {
				"MONTHS_LONG" : [ "Enero", "Febrero", "Marzo", "Abril", "Mayo",
						...
						"Noviembre", "Diciembre" ],
				"WEEKDAYS_SHORT" : [ "Do", "Lu", "Ma", "Mi", "Ju", "Vi",
						"S\xe1" ],
				"START_WEEKDAY" : 1
			},
			navigator : {
		...
		"nl" : {
			properties : {
				"MONTHS_LONG" : [ "Januari", "Februari", "Maart", "April",
		...
		"de" : {
			properties : {
				"MONTHS_LONG" : [ "Januar", "Februar", "M\u00E4rz", "April",
						"Mai", "Juni", "July", "August", "September",
		...
		"no" : {
			properties : {
				"MONTHS_LONG" : [ "Januar", "Februar", "Mars", "April", "Mai",
						"Juni", "Juli", "August", "September", "Oktober",
						"November", "Desember" ],
				"WEEKDAYS_SHORT" : [ "s\u00F8", "ma", "ti", "on", "to", "fr",
						"l\u00F8" ],
				"START_WEEKDAY" : 1
			},
			navigator : {
		...
		"ru" : {
			properties : {
				"MONTHS_LONG" : [ "\u042F\u043D\u0432\u0430\u0440\u044C",
						...
						"\u041D\u043E\u044F\u0431\u0440\u044C",
						"\u0414\u0435\u043A\u0430\u0431\u0440\u044C" ],
				"MONTHS_SHORT" : [ "\u042f\u043d\u0432", "\u0424\u0435\u0432",
						"\u041c\u0430\u0440", "\u0410\u043f\u0440",
						"\u041c\u0430\u0439", "\u0418\u044e\u043d",
						"\u0418\u044e\u043b", "\u0410\u0432\u0433",
						"\u0421\u0435\u043d", "\u041e\u043a\u0442",
						"\u041d\u043e\u044f", "\u0414\u0435\u043a" ],
				"WEEKDAYS_SHORT" : [ "\u0412\u0441", "\u041F\u043D",
						"\u0412\u0442", "\u0421\u0440", "\u0427\u0442",
						"\u041F\u0442", "\u0421\u0431" ],
				"START_WEEKDAY" : 1
			},
		...
		"pl" : {
			properties : {
				"MONTHS_LONG" : [ "Stycze\u0144", "Luty", "Marzec",
						"Kwiecie\u0144", "Maj", "Czerwiec", "Lipiec",
						"Sierpie\u0144", "Wrzesie\u0144", "Pa\u017Adziernik",
						"Listopad", "Grudzie\u0144" ],
				"WEEKDAYS_SHORT" : [ "Nd", "Pn", "Wt", "\u015Ar", "Cz", "Pt",
						"Sb" ],
				"START_WEEKDAY" : 0
			},
			navigator : {
