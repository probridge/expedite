...
<!-- Bootstrap -->
<link href="/ops/exp_res/css/bootstrap.min.css" rel="stylesheet" media="screen"/>
<link rel="stylesheet" href="/ops/exp_res/css/font-awesome.min.css"/>
<link rel="stylesheet" href="/ops/exp_res/css/bootswatch.min.css"/>
<link href="/ops/exp_res/css/jquery.pnotify.default.css" media="all" rel="stylesheet" type="text/css" />
<!-- Customize -->
...
<body>
		...
		<div class="navbar navbar-default">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="./" style="padding-top: 5px; padding-bottom: 0px"><img src="/ops/exp_res/imgs/vbox_logo.png" title="${ requestScope.version }"/></a>
				</div>
	...
	<script type="text/javascript" src="/ops/exp_res/js/jquery.pnotify.min.js"></script>
