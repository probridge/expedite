...
<p><c:out value="${ sessionScope.error }"/>如有问题请<a href="#" class="alert-link">联系我们</a>。</p>
</div>
</div>
</div>
</c:if>
...
<div class="row">
	<div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-5 hidden-xs"> 
		<img src="/ops/exp_res/imgs/register.png"/>
	</div>
				...
				<div class="form-group">
					...
					<div class="input-group" style="width: 100%">
						<input type="email" class="form-control" id="inputEmail" name="inputEmail"
							placeholder="您的邮箱地址" maxlength="30" required="required"/>
			         </div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-8 col-md-8 col-sm-8">
					<div class="input-group" style="width: 100%">
						<input type="password" class="form-control" id="inputPassword1" name="inputPassword1" required="required" maxlength="30"/>
			         </div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-8 col-md-8 col-sm-8">
					<div class="input-group" style="width: 100%">
						<input type="password" class="form-control" id="inputPassword2" name="inputPassword2" required="required" maxlength="30" data-validation-match-match="inputPassword1"/>
			         </div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-lg-4 col-lg-offset-3 col-md-4 col-md-offset-3 col-sm-4 col-sm-offset-4">
						<button type="submit" class="btn btn-primary btn-sm" style="width: 80px;"><i class="icon-lock icon-large spacer-right"></i>注册</button>
					</div>
				</div>
				</fieldset>
			</form>
