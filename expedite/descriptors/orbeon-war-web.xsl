        ...
        client-side software or plug-ins.
            ...
            <filter>
                ...
                <init-param>
                    ...
                    <param-value>/, /pages/index.jsp, /pages/index-en.jsp, /pages/login.jsp, /pages/login-en.jsp, /pages/logout.jsp, /pages/register.jsp, /pages/about.jsp, /jaccount, /logout, /login, /register, /xforms-renderer, /ops/, /config/theme/, /apps/fr/style/, /fr/style/</param-value>
                </init-param>
            </filter>
            <filter-mapping>
                <filter-name>expedite-filter</filter-name>
